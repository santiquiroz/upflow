...
- ✍️ **Prompts listos para generar** — cada modo (texto a imagen, imagen a imagen y video) arranca con prompts probados que completan el campo con un click y quedan editables. Los de video describen movimiento, que es lo que separa un clip de una foto que tiembla.

...
- 🧭 **Lo que la IA 3D todavía no puede hacer, dicho en la pantalla** — la app lista los cuatro carriles de impresión y admite cuáles no están: reparación de malla, laminado real y generación de foto a malla. Ese último trae el motivo medido: TRELLIS es MIT pero depende de kernels CUDA y de nvdiffrast, que sí es no comercial; la familia Hunyuan3D está bloqueada por su propia licencia; TripoSR es MIT en código y pesos con camino verificado en CPU. Y lo más importante para piezas industriales: **ningún generador de malla da cotas ni aristas vivas**, así que para una pieza que tiene que encajar el camino es CAD paramétrico, no generación. Ver [`docs/superpowers/specs/2026-08-05-3d-engines-license-findings.md`](docs/superpowers/specs/2026-08-05-3d-engines-license-findings.md).

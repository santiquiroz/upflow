...
export const es = {
  ...
  "audio.ensemble.title": "Maxima calidad: combinar modelos",
  "audio.ensemble.why": "Cada arquitectura falla distinto. Al promediar, lo que estiman igual se refuerza y sus artefactos propios se cancelan en parte. No arregla lo que ninguno logro separar.",
  "audio.ensemble.cost": "{{count}} pasadas completas sobre el tema: tarda {{count}} veces mas.",
  ...
  "karaoke.file.drop": "Arrastrá la canción acá o hacé clic para buscarla",
  "karaoke.file.formats": "Audio o video: WAV, MP3, FLAC, M4A, MP4, MKV, WEBM…",
  "karaoke.file.inputLabel": "Elegir la canción",
  "karaoke.config.separation": "Modelo de separación",
  "karaoke.config.separationDefault": "El del catálogo (recomendado)",
  "karaoke.config.cleanup": "Limpieza del instrumental",
  "karaoke.config.cleanupHint":
    "Pasadas opcionales sobre el instrumental ya separado. Cada una es con pérdida: usá las que el material pida.",
  "karaoke.config.cleanupToggle": "Limpiar el instrumental",
  "karaoke.config.overprocessing":
    "Tres pasadas con pérdida encadenadas: el resultado puede sonar sobreprocesado.",
  "karaoke.config.restore": "Mejora del instrumental",
  "karaoke.config.restoreNone": "Ninguna",
  "karaoke.config.restore.apollo": "Apollo: restaurar los agudos que perdió la compresión",
  "karaoke.config.restore.audiosr": "AudioSR: super-resolución de audio (lenta, la más profunda)",
  "karaoke.config.asrModel": "Modelo de reconocimiento de voz",
  "karaoke.config.translate": "Traducir la letra",
  "karaoke.config.translateNone": "No traducir",
  "karaoke.config.translateHint":
    "La traducción sale apilada debajo de la letra original, con resaltado por línea.",
  "karaoke.submit": "Preparar karaoke",
  "karaoke.preparing": "Separando, limpiando y transcribiendo…",
  "karaoke.rendering": "Renderizando el video…",
  "karaoke.cancel": "Cancelar",
  "karaoke.reset": "Empezar de nuevo",
  "karaoke.review.listen": "Escuchá el instrumental",
  "karaoke.review.lyrics": "Letra (editable)",
  "karaoke.review.lineLabel": "Línea {{index}}",
  "karaoke.review.translationLabel": "Traducción de la línea {{index}}",
  "karaoke.review.save": "Guardar la letra",
  "karaoke.background.label": "Fondo del video",
  "karaoke.background.source": "El video original",
  "karaoke.background.image": "Una imagen",
  "karaoke.background.video": "Un video",
  "karaoke.background.generated": "Fondo liso",
  "karaoke.background.sourceUnavailable":
    "El archivo original no trae imagen que sirva de fondo.",
  "karaoke.background.filePick": "Elegir el archivo de fondo",
  "karaoke.style.size": "Tamaño de la letra",
  "karaoke.style.size.small": "Chica",
  "karaoke.style.size.medium": "Mediana",
  "karaoke.style.size.large": "Grande",
  "karaoke.style.position": "Posición",
  "karaoke.style.position.bottom": "Abajo",
  "karaoke.style.position.top": "Arriba",
  "karaoke.style.base": "Color de la letra",
  "karaoke.style.highlight": "Color al cantarse",
  "karaoke.render": "Renderizar el video",
  "karaoke.done.download": "Descargar el karaoke",
  "karaoke.singers.legend": "Cantantes",
  "karaoke.singers.toggle": "Detectar quién canta cada línea",
  "karaoke.singers.hint":
    "Agrupa las líneas de la letra por voz para darle un color a cada cantante y poder mutearlo para practicar. Funciona cuando los cantantes se turnan.",
  "karaoke.singers.count": "Cuántos cantantes",
  "karaoke.singers.badgeLabel": "Cantante de la línea {{index}}",
  "karaoke.singers.renameLabel": "Renombrar al cantante {{label}}",
  "karaoke.singers.colorLabel": "Color de {{name}}",
  "karaoke.singers.practiceAs": "Practicar como",
  "karaoke.singers.practiceNone": "Nadie: dejar todas las voces",
  "karaoke.singers.practiceHint":
    "Mutea las líneas de ese cantante en el render para que las cantes vos; las otras voces quedan. La mezcla muteada también sale como descarga de audio.",
  "karaoke.singers.unisonWarning":
    "Dos cantantes sobre la misma melodía a la vez (unísono) no se pueden distinguir: esas líneas quedan con quien eligió el detector.",
  "karaoke.singers.practiceDownload": "Descargar la mezcla de práctica (audio)",
  ...
  "audio.karaoke.credit":
    "Modelos distribuidos por el canal oficial de descargas de Ultimate Vocal Remover: Anjok07 & aufr33 (MIT) — incluye MDX-Net KARA 2 (voz principal/coros; re-hosteado por Politrees, autor original sin licencia declarada) — y Reverb HQ / De-Echo / De-Reverb / De-Noise de FoxJoy (port a ONNX: santiquiroz/port-uvr-deecho-onnx, MIT). Mel-Band RoFormer es de KimberleyJSN (MIT), port a ONNX: santiquiroz/port-bs-roformer-onnx.",
  ...
  "audio.karaoke.model.kara_2.description":
    "Karaoke con armonías: deja los coros adentro de la instrumental y saca solo la voz líder (el resto).",
  ...
  "audio.stem.lead_vocals": "Voz principal",
  "audio.stem.backing_vocals": "Coros",
  "audio.stem.minus_vocals": "Sin voces",
  "audio.stem.minus_drums": "Sin batería",
  "audio.stem.minus_bass": "Sin bajo",
  "audio.stem.minus_other": "Sin el resto",
  "audio.rehearsal.title": "Ensayo (minus-one)",
  "audio.rehearsal.tooltip":
    "Por cada instrumento elegido se hornea una copia descargable de la mezcla completa SIN ese instrumento, para tocar tu propia parte encima en el ensayo. Opcional: dejar el instrumento quitado a bajo volumen como guía.",
  "audio.rehearsal.toggle": "Armar pistas de práctica minus-one",
  "audio.rehearsal.summary": "{{count}} minus-one",
  "audio.rehearsal.stemsLegend": "Instrumentos a quitar",
  "audio.rehearsal.guideLegend": "Volumen de guía del instrumento quitado",
  ...
  "modeling.proportions.title": "Proporciones medidas",
  "modeling.proportions.headsTall": "Altura en cabezas",
  "modeling.proportions.headHeight": "Altura de la cabeza",
  "modeling.proportions.landmarks": "Referencias de altura",
  "modeling.proportions.unreliable": "No confiable",
  "modeling.proportions.disagreement": "Las vistas difieren {{cm}} cm",
  "modeling.proportions.widths": "Anchos por altura",

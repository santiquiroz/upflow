...
export const en = {
  ...
  "audio.format.mp3.description": "Lossy, smallest file — only if size matters more than quality.",
  ...
  "enhance.runtime.tooltip": "Choose which backend runs the model. Auto picks the fastest backend for your GPU (ONNX/DirectML is ~2x faster on modern GPUs for video); NCNN Vulkan is the portable fallback that runs on any GPU.",
  ...
  "enhance.runtime.onnxHint": "~2× faster on modern GPUs for video",
  ...
  "transcribe.models.verified.hint": "Tested on this app with real speech. Small and fast — a good first model.",
